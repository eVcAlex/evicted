...
/**
 * Deliberately public and unauthenticated: opting a device in or out of
 * notifications is a personal preference, not a money-affecting write, so it
 * needs no admin auth the way the paid-status endpoints do.
 */
